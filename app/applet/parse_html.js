...
rows.each((i, row) => {
  ...
  // In the HTML, section headers like "구약 보존", "신약 보존" span multiple columns or have specific styling.
  // Let's just extract all text from the row.
  const rowText = $(row).text().trim();
  
  // Let's find images in this row
  const images = [];
